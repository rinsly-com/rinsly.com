...
export function Cta({ eyebrow, title, text, button, locale }: Props) {
  return (
    <Section className="py-12 sm:py-16">
      <div className="relative flex flex-col items-start justify-between gap-6 overflow-hidden rounded-2xl bg-slate px-7 py-8 text-slate-ink sm:flex-row sm:items-center">
