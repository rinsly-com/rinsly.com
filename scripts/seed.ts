...
const privacyNodes: Record<Locale, ProseNode[]> = {
  nl: [
    ...
    { p: 'Voor de hosting en werking van de website maken we gebruik van Cloudflare, Inc., dat als verwerker in onze opdracht persoonsgegevens verwerkt. We verkopen de gegevens van websitebezoekers en contactpersonen niet en delen deze niet met derden, behalve wanneer dat noodzakelijk is voor de genoemde doeleinden of wanneer we daartoe wettelijk verplicht zijn. Voor bedrijfsgegevens die wij zelf verzamelen door websites te meten geldt een eigen regeling: die kunnen wij delen met onze partners, onder de voorwaarden in artikel 7.' },
